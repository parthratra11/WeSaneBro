      ...
      <main className="min-h-screen bg-black text-white">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            {/* BrainBot Product */}
            <div className="bg-gray-900 p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow flex flex-col h-[600px]">
              <Image
              ...
              <div className="flex flex-col flex-grow">
                <h3 className="text-2xl font-bold mb-2 text-white">Kebo</h3>
                <p className="mb-4 text-gray-300 flex-grow">
                  An intelligent robotic companion designed to assist and support
                  neurodiverse individuals.
                </p>
                <button className="w-full bg-red-600 hover:bg-red-700 text-white py-3 px-4 rounded-xl transition-colors">
                  Purchase Kebo
                </button>
              </div>
            </div>
            ...
            <div className="bg-gray-900 p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow flex flex-col h-[600px]">
              ...
              />
              <div className="flex flex-col flex-grow">
                <h3 className="text-2xl font-bold mb-2 text-white">KebOS</h3>
                <p className="mb-4 text-gray-300 flex-grow">
                  A companion app that enhances the Kebo experience with
        ...
        <section
          id="about"
          className="py-24 px-4 bg-gradient-to-br from-black via-gray-900 to-black"
        >
          <div className="max-w-6xl mx-auto relative">
            <h2 className="text-5xl font-bold text-center mb-20 text-red-600">
              About Us
            </h2>

            <div className="grid md:grid-cols-2 gap-16">
              <div className="space-y-8">
                <div className="bg-gray-900/50 backdrop-blur-sm p-8 rounded-lg border border-gray-800 hover:border-red-600 transition-all duration-300 h-[300px] flex flex-col">
